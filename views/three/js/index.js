...
const templateHTML  = ` 
        ...
        label#switch{
            ...
            background: var(--off-color,#8B4513);
            box-shadow: 0 1px var(--highlight-scale,4px) -1px var(--off-color,#8B4513);
        ...
        :host([aria-checked = "true"][checked]) label#switch {
            background: var(--on-color,#8B4513);
            box-shadow: 0 2px var(--highlight-scale,4px) -1px var(--on-color,#8B4513);
        }
